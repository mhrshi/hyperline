const JoinSvg = () => (
  ...
  >
    <defs>
      ...
      <linearGradient xlinkHref="#a" id="b" x1="710.91" x2="710.91" y1="187.1" y2="36.05" />
      <linearGradient xlinkHref="#a" id="c" x1="551" x2="551" y1="311.01" y2="159.96" />
      <linearGradient xlinkHref="#a" id="d" x1="66.72" x2="66.72" y1="439.07" y2="305.63" />
      <linearGradient xlinkHref="#a" id="e" x1="77.31" x2="77.31" y1="432.72" y2="299.28" />
      <linearGradient xlinkHref="#a" id="f" x1="509.01" x2="509.01" y1="292.43" y2="202.06" />
      <linearGradient xlinkHref="#a" id="g" x1="371.86" x2="371.86" y1="825" y2="147.87" />
    </defs>
    <circle cx="391.06" cy="106.19" r="75.53" fill="url(#a)" opacity=".5" />
    ...
    />
    <path d="M379.02 142.51a32.91 32.91 0 0 0 22.87.06v-2.81h-22.87Z" opacity=".1" />
    ...
    />
    <ellipse cx="357.7" cy="111.23" fill="#fda57d" rx="3.05" ry="5.72" />
    <ellipse cx="423.26" cy="111.23" fill="#fda57d" rx="3.05" ry="5.72" />
    <circle cx="710.91" cy="111.58" r="75.53" fill="url(#b)" opacity=".5" />
    ...
    />
    <path d="M698.87 147.9a32.91 32.91 0 0 0 22.87.06v-2.81h-22.87Z" opacity=".1" />
    <circle cx="710.34" cy="116.65" r="32.77" fill="#fda57d" />
    <path d="M687 86.84s13.81 28 52.78 11.75l-9.07-14.22-16.08-5.77Z" opacity=".1" />
    <path fill="#72351c" d="M687 86.43s13.81 28 52.78 11.75L730.71 84l-16.08-5.77Z" />
    <path
      fill="#72351c"
    ...
    />
    <ellipse cx="677.56" cy="116.62" fill="#fda57d" rx="3.05" ry="5.72" />
    <ellipse cx="743.11" cy="116.62" fill="#fda57d" rx="3.05" ry="5.72" />
    <circle cx="551" cy="235.49" r="75.53" fill="url(#c)" opacity=".5" />
    ...
    />
    <path d="M538.95 271.8a32.91 32.91 0 0 0 22.87.06v-2.81h-22.87Z" opacity=".1" />
    <circle cx="550.43" cy="240.56" r="32.77" fill="#be7c5e" />
    <path fill="#333" d="M519.09 228.11h62.5s-5.34-25.24-29-23.63-33.5 23.63-33.5 23.63Z" />
    <ellipse cx="518.33" cy="239.16" fill="#be7c5e" rx="3.05" ry="5.72" />
    <ellipse cx="582.35" cy="239.16" fill="#be7c5e" rx="3.05" ry="5.72" />
    <path d="M519.09 229h62.5s-5.34-25.24-29-23.63-33.5 23.63-33.5 23.63Z" opacity=".1" />
    <path
      fill="#ccc"
    ...
    />
    <path d="M56.08 404.43a29.07 29.07 0 0 0 20.2.06V402h-20.2Z" opacity=".1" />
    <circle cx="66.22" cy="376.83" r="28.95" fill="#ccc" />
    <path d="M45.6 350.5s12.2 24.77 46.62 10.38l-8-12.57-14.21-5.1Z" opacity=".1" />
    <path fill="#ccc" d="M45.6 350.13s12.2 24.77 46.62 10.38l-8-12.57-14.21-5.1Z" />
    <path
      fill="#ccc"
    ...
    />
    <ellipse cx="37.25" cy="376.81" fill="#ccc" rx="2.69" ry="5.05" />
    <ellipse cx="95.17" cy="376.81" fill="#ccc" rx="2.69" ry="5.05" />
    <circle cx="77.31" cy="366" r="66.72" fill="url(#e)" opacity=".5" />
    ...
    />
    <path d="M66.67 398.08a29.07 29.07 0 0 0 20.2.06v-2.48h-20.2Z" opacity=".1" />
    <circle cx="76.81" cy="370.48" r="28.95" fill="#ccc" />
    <path d="M56.19 344.14s12.2 24.77 46.62 10.38l-8-12.57-14.21-5.1Z" opacity=".1" />
    <path fill="#ccc" d="M56.19 343.78s12.2 24.77 46.62 10.38l-8-12.57-14.21-5.1Z" />
    <path
      fill="#ccc"
    ...
    />
    <ellipse cx="47.84" cy="370.45" fill="#ccc" rx="2.69" ry="5.05" />
    <ellipse cx="105.76" cy="370.45" fill="#ccc" rx="2.69" ry="5.05" />
    <path
      fill="url(#f)"
    ...
    <path
      fill="#edeef9"
      d="m132.74 190.63-5.81 17.06 59.72-2.14-22.94-13.77-30.97-1.15zM284.53 207.84l3.06-3.82 25.99 15.29v6.88l-29.05-18.35z"
    />
    <path
      fill="#4d8af0"
    ...
    <path
      fill="#333"
      d="m158.02 715.56 7.59-27.26 42 11.69s-.13 11.87 18.41 19.41-13.15 13-13.15 13Z"
    />
    <path
      d="m208.47 383.33-99.58-4a55.71 55.71 0 0 1 .75 18.05c4.56 10.72 14.33 7.78 14.33 7.78l87.13-2.68Z"
      opacity=".1"
    />
    <path
      fill="#535461"
      d="m128.92 201.34-44.35 30 8.79 48s22.18 43.39 15.29 86.78 15.29 36.71 15.29 36.71l87.53-2.67 6.5-131.65s52.79 7.49 76.5-10.85l19.12-29.2-29.06-20-9.94 14.18s-31.12-6.64-48.24-13.54a73.07 73.07 0 0 0-25.07-5.37Z"
    />
    <path
